...
$(document).ready(function () {
  ...
  // configuracion del mapa
            ...
            return new Promise(function(resolve){
              ...
              //	console.log('laboratorio',laboratorio.val());
                    ...
                    if (leaftobj[laboratorio.val().cod_escuela]!==undefined) {
                        ...
                        objpruebas.colaborador = laboratorio.val().colaborador;
      ...
      $('#menu-general-laboratorio').on('click', function () {// genera formularios para actualizar informacion general
          ...
          db.ref("informacion_laboratorios").orderByChild('colaborador').equalTo(email).on("child_added", function (laboratorio) {
      ...
      var correo = function (email_colaborador, email_director, dato_modificado,  ) {
        $.ajax({
          method: "POST",
          ...
          data: {
            para: email_director,
            asunto: 'Notificación Sigelab :: el dato '+dato_modificado+' ha sido cambiado',
            mensaje: 'Hola, el usuario '+email_colaborador+' modifico el dato '+dato_modificado+'.' 
